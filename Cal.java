...
public class Cal extends JPanel {
    ...
    protected int yy;                                           /** The currently-interesting year (not modulo 1900!) */
    protected int mm, dd;                                                     /** Currently-interesting month and day */
    protected JButton labs[][];                                                       /** The buttons to be displayed */
    protected int leadGap = 0;                /** The number of day squares to leave blank at the start of this month */


    Calendar calendar = new GregorianCalendar();                                /** A Calendar object used throughout */


    protected final int thisYear = calendar.get(Calendar.YEAR);                                      /** Today's year */
    protected final int thisMonth = calendar.get(Calendar.MONTH);                                   /** Today's month */


    private JButton b0;                       /** One of the buttons. We just keep its reference for getBackground(). */

    private JComboBox monthChoice;                                                               /** The month choice */
    private JComboBox yearChoice;                                                                 /** The year choice */
